...
import { searchStudents,addUpdateStudent } from '@/api/student'
...
export default class extends Vue {
  ...
  private async getList() {
    ...
    const { data } = await searchStudents(this.listQuery)
  ...
  private async confirmAddUpdate() {
    ...
    if (isEdit) {
        ...
        formdata.append("StudentId",this.dataObj.StudentId.toString())
    }
    ...
    if (isEdit) {
      await addUpdateStudent(formdata)
